...
from consts import MAPPING, SQL, MODEL, API, DTO
...
def main():
    ...
    salvar_arquivos_gerados("./", model, dto, service, api, mapping, service_js, router_js, visualizar_html, incluir_html, consultar_html, visualizar_js, alterar_js, consultar_js, incluir_js, nomeEntidade)
